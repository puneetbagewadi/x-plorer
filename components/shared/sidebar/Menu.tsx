...
export function Menu({ isOpen }: MenuProps) {
  ...
  return (
    <ScrollArea className="max-h-max [&>div>div[style]]:!block">
      <nav className="h-auto w-full">
        <ul className="flex min-h-[calc(100vh-48px-36px-16px-32px)] flex-col items-start gap-y-8 space-y-1 px-2 lg:min-h-[calc(100vh-32px-40px-32px)] ">
